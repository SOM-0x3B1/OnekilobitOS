...
const arrows = new Audio('media/arrows.mp3');
const signal = new Audio('media/signal.mp3');
const click = new Audio('media/click.mp3');
/*const msgin = new Audio('media/msgin.wav');
const msgout = new Audio('media/msgout.wav');
